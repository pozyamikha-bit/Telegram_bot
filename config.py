...
GOOGLE_SHEET_WORKSHEET_PROMO_ITEMS = os.getenv("GOOGLE_SHEET_WORKSHEET_PROMO_ITEMS", "Акционные позиции")
GOOGLE_SHEET_WORKSHEET_SALES_REPORT = os.getenv("GOOGLE_SHEET_WORKSHEET_SALES_REPORT", "Отчёт по продажам")
GOOGLE_SHEET_WORKSHEET_COUPONS = os.getenv("GOOGLE_SHEET_WORKSHEET_COUPONS", "Купоны")
