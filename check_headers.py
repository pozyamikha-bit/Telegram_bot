...
CHECKS = [
    ...
    (config.GOOGLE_SHEET_WORKSHEET_PROMO_ITEMS, google_sheets.PROMO_ITEMS_HEADER),
    (config.GOOGLE_SHEET_WORKSHEET_SALES_REPORT, google_sheets.SALES_REPORT_HEADER),
    (config.GOOGLE_SHEET_WORKSHEET_COUPONS, google_sheets.COUPONS_HEADER),
]
